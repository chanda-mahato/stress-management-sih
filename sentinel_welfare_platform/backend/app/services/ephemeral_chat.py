...
class EphemeralChatManager:
    ...
    def generate_reply(
        ...
        if nlp_res["is_crisis"]:
            ...
            reply = get_reply({
                "hi": "जय हिंद जवान साथी! कृपया शांत रहें और अपना ध्यान रखें। आपकी सुरक्षा और जीवन सर्वोपरि हैं। आपके कल्याण एवं चिकित्सा सहायता हेतु यूनिट मेडिकल ऑफिसर (MO) को एक गोपनीय सहायता अलर्ट भेज दिया गया है — यह पूर्णतः गैर-दंडात्मक है और आपकी सेवा रिकॉर्ड को प्रभावित नहीं करेगा। आप टेली-मानस हेल्पलाइन 14416 / 1800-891-4416 पर भी तुरंत बात कर सकते हैं। आप अकेले नहीं हैं।",
                "pa": "ਸਤਿ ਸ਼੍ਰੀ ਅਕਾਲ ਜਵਾਨ ਵੀਰ! ਕਿਰਪਾ ਕਰਕੇ ਸ਼ਾਂਤ ਰਹੋ। ਤੁਹਾਡੀ ਸੁਰੱਖਿਆ ਸਭ ਤੋਂ ਮਹੱਤਵਪੂਰਨ ਹੈ। ਤੁਹਾਡੀ ਮਦਦ ਲਈ ਯੂਨਿਟ ਡਾਕਟਰ (MO) ਨੂੰ ਸੁਨੇਹਾ ਭੇਜਿਆ ਗਿਆ ਹੈ। ਇਹ ਗੁਪਤ ਅਤੇ ਬਿਨਾਂ ਕਿਸੇ ਸਜ਼ਾ ਦੇ ਹੈ। ਟੈਲੀ-ਮਾਨਸ ਹੈਲਪਲਾਈਨ 14416 'ਤੇ ਵੀ ਗੱਲ ਕਰੋ।",
                "bn": "জয় হিন্দ জওয়ান ভাই! অনুগ্রহ করে শান্ত থাকুন। আপনার চিকিৎসার জন্য ইউনিট মেডিকেল অফিসারকে (MO) গোপনীয় বার্তা পাঠানো হয়েছে — এটি সম্পূর্ণ অ-দণ্ডনীয়। টেলি-মানস হেল্পলাইন ১৪৪১৬ এ কথা বলুন।",
                "mr": "जय हिंद जवान बंधू! कृपया शांत राहा. तुमच्या मदतीसाठी युनिट मेडिकल ऑफिसरला (MO) संदेश पाठवण्यात आला आहे — हे पूर्णपणे गोपनीय व बिनशिक्षेचे आहे. टेलि-मानस हेल्पलाइन १४४१६ वर संपर्क साधा.",
                "ta": "ஜெய் ஹிந்த் தோழரே! தயவுசெய்து அமைதியாக இருங்கள். மருத்துவ அதிகாரியிடம் (MO) தகவல் தெரிவிக்கப்பட்டுள்ளது. உதவிக்கு டெலி-மானஸ் 14416 ஐ அணுகவும்.",
                "te": "జై హింద్ సోదరా! దయచేసి ప్రశాంతంగా ఉండండి. మీ సహాయానికి వైద్య అధికారికి (MO) సమాచారం అందించబడింది. టెలి-మానస్ 14416 ని సంప్రదించండి.",
                "en": "Jai Hind comrade! Please stay safe and take a moment to pause. Your life and wellbeing are irreplaceable. An urgent confidential support alert has been forwarded to your Unit Medical Officer (MO) so immediate care can be coordinated. This is strictly non-punitive and will not impact your service record. You can also connect directly with Tele-MANAS (14416 / 1800-891-4416). You are not alone."
            })
