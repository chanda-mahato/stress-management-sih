...
def list_personnel(db: Session = Depends(get_db), user: dict = Depends(enforce_mo_scope)):
    ...
    for p in personnel_list:
        ...
        out.append({
            ...
            "age": p.age,
            "service_tenure_years": p.service_tenure_years,
            "distance_from_home_station_km": p.distance_from_home_station_km,
            "leave_backlog_days": p.leave_backlog_days,
            "days_since_last_leave": p.days_since_last_leave,
            ...
            "overtime_hours_monthly": p.overtime_hours_monthly,
            "family_separation_months": p.family_separation_months,
            "body_mass_index": p.body_mass_index,
            "annual_fitness_grade_encoded": p.annual_fitness_grade_encoded,
            "promotion_stagnation_years": p.promotion_stagnation_years,
            "unit_manning_shortfall_pct": p.unit_manning_shortfall_pct,
            "latest_risk": {
